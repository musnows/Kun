...
All three SDKs are currently version `1.1.0` for Extension API major 1. Hosts continue to accept v1.0 manifests; v1.1 adds optional media, jobs, and generated-artifact surfaces without changing existing v1.0 methods. Manifest fields use the generated [JSON Schema](../../packages/extension-api/schema/kun-extension.schema.json) and `ExtensionManifestSchema` as their machine-enforced sources. Published `.d.ts` declarations and runtime Schemas govern Host APIs, events, and payloads.
