...
- Ship a runnable `kun-video-editor` `.kunx` extension with a full-page React workbench, Agent profile, editable project/timeline model, transcript-oriented editing tools, subtitles, social aspect-ratio presets, preview assets, and background export.
...
- Renderer: extension media client, result-preview/artifact mapping, full-page contribution behavior, and generated-file actions.
